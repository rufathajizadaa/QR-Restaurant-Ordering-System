        ...
        <CardContent>
          <div className="grid grid-cols-4 gap-2 mb-4 text-center text-sm">
            ...
            <div className="bg-blue-50 p-2 rounded-md">
              <div className="font-medium text-blue-700">Preparing</div>
            ...
            <div className="bg-purple-50 p-2 rounded-md">
              <div className="font-medium text-purple-700">Delivered</div>
              ...
              <div key={order.id} className="border rounded-md p-3">
                ...
                <ul className="space-y-1 text-sm">
                  {order.items.map((item, index) => (
                    <li key={`${item.itemId}-${index}`} className="flex flex-col">
